...
# class MainWindow:  # Opening Window
...
#         #self.main_window.setWindowFlag(flag)
...
#         self.top_button = QtWidgets.QPushButton('Top #1', self.main_window)
...
#     def top_window(self):    
#         self.top_window.setWindowTitle("High Score")
#         self.top_window.setGeometry(100, 100, 300, 150)

#         self.top_window.layout = QVBoxLayout()

#         self.top_window.score_label = QLabel("Highest Score: Loading...", self)
#         self.top_window.score_label.setStyleSheet("font-size: 18px; font-weight: bold;")
#         self.top_window.layout.addWidget(self.score_label)

#         self.top_window.setLayout(self.layout)
#         self.top_window.load_high_score()
...
#                 self.score_label.setText(f"Highest Score: {score}")
#         else:
#             self.score_label.setText("Highest Score: 0")
