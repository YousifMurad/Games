...
class Settings:
    def __init__(self):
        ...
        self.fields_background = pygame.image.load("gameConcept/fields_background.png")
        self.level_text = pygame.image.load("gameConcept\level45 (1).png")
        ...
        self.losing_phrase = pygame.image.load("gameConcept/AreTheseYoursPurple.png")
